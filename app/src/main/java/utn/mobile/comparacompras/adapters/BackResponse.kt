...
class ProductMarketResponse(val product: ProductResponse, val idMarket: Long, val price: Number, val imageUrl: String, val distance: Double, val totalPrice: Double)
